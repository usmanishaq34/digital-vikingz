...
.logo { font-family: var(--display); font-weight: 600; font-size: 22px; letter-spacing: -0.02em; color: var(--text); text-decoration: none; display: flex; align-items: center; gap: 10px; }
.logo-mark { width: 36px; height: 36px; object-fit: contain; background: #fff; padding: 3px; border-radius: 10px; transition: transform 0.4s ease; }
...
<footer style={{ background: "#0a0a0a", padding: "80px 0 32px", color: "rgba(255,255,255,0.7)" }}>
        <div style={{ maxWidth: "1320px", margin: "0 auto", padding: "0 32px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1fr", gap: "48px", marginBottom: "64px", paddingBottom: "48px", borderBottom: "1px solid rgba(255,255,255,0.1)" }} className="dv-footer-grid">
            {/* BRAND COLUMN */}
            <div>
              <a href="/" style={{ display: "flex", alignItems: "center", gap: "10px", textDecoration: "none", marginBottom: "24px" }}>
                ...
                />
                <span style={{ fontFamily: "'Fraunces',Georgia,serif", fontSize: "22px", fontWeight: 600, color: "#fff", letterSpacing: "-0.02em" }}>
                  Digital Vikingz
                </span>
              </a>
              <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "14px", lineHeight: 1.7, maxWidth: "360px", marginBottom: "24px" }}>
              ...
              <div style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: "11px", color: "rgba(255,255,255,0.5)", letterSpacing: "0.12em", textTransform: "uppercase" }}>
            ...
            {/* SERVICES COLUMN */}
            <div>
              <h5 style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: "11px", color: "#db4c23", letterSpacing: "0.18em", textTransform: "uppercase", marginBottom: "24px", fontWeight: 600 }}>
                Services
              </h5>
              <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                <li style={{ marginBottom: "12px" }}><a href="/services/semantic-seo-architecture" style={{ color: "rgba(255,255,255,0.7)", textDecoration: "none", fontSize: "14px" }}>Semantic SEO Architecture</a></li>
                <li style={{ marginBottom: "12px" }}><a href="/services/semantic-content-audit" style={{ color: "rgba(255,255,255,0.7)", textDecoration: "none", fontSize: "14px" }}>Semantic Content Audit</a></li>
                <li style={{ marginBottom: "12px" }}><a href="/services/llm-ai-search-visibility" style={{ color: "rgba(255,255,255,0.7)", textDecoration: "none", fontSize: "14px" }}>LLM &amp; AI Search Visibility</a></li>
                <li style={{ marginBottom: "12px" }}><a href="/services/authority-link-building" style={{ color: "rgba(255,255,255,0.7)", textDecoration: "none", fontSize: "14px" }}>Authority Link Building</a></li>
                <li style={{ marginBottom: "12px" }}><a href="/services/semantic-content-network" style={{ color: "rgba(255,255,255,0.7)", textDecoration: "none", fontSize: "14px" }}>Semantic Content Network</a></li>
                <li style={{ marginBottom: "12px" }}><a href="/services/semantic-content-production" style={{ color: "rgba(255,255,255,0.7)", textDecoration: "none", fontSize: "14px" }}>Semantic Content Production</a></li>
                <li style={{ marginBottom: "12px" }}><a href="/services/pipeline-attribution-seo" style={{ color: "rgba(255,255,255,0.7)", textDecoration: "none", fontSize: "14px" }}>Pipeline Attribution SEO</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                <li style={{ marginBottom: "12px" }}><a href="/about" style={{ color: "rgba(255,255,255,0.7)", textDecoration: "none", fontSize: "14px" }}>About Us</a></li>
                <li style={{ marginBottom: "12px" }}><a href="/contact" style={{ color: "rgba(255,255,255,0.7)", textDecoration: "none", fontSize: "14px" }}>Contact Us</a></li>
                <li style={{ marginBottom: "12px" }}><a href="/blog" style={{ color: "rgba(255,255,255,0.7)", textDecoration: "none", fontSize: "14px" }}>Blogs</a></li>
                <li style={{ marginBottom: "12px" }}><a href="/operating-manual" style={{ color: "rgba(255,255,255,0.7)", textDecoration: "none", fontSize: "14px" }}>Operating Manual</a></li>
                <li style={{ marginBottom: "12px" }}><a href="/build-process" style={{ color: "rgba(255,255,255,0.7)", textDecoration: "none", fontSize: "14px" }}>Build Process</a></li>
                <li style={{ marginBottom: "12px" }}><a href="/vertical-playbooks" style={{ color: "rgba(255,255,255,0.7)", textDecoration: "none", fontSize: "14px" }}>Vertical Playbooks</a></li>
            ...
            <div>
              ...
              <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                <li style={{ marginBottom: "12px" }}>
                  <a href="https://www.linkedin.com/company/digital-vikingz/" target="_blank" rel="noopener" style={{ color: "rgba(255,255,255,0.7)", textDecoration: "none", fontSize: "14px", display: "flex", alignItems: "center", gap: "8px" }}>
                ...
                <li style={{ marginBottom: "12px" }}>
                  <a href="https://www.facebook.com/DigitalVikingz" target="_blank" rel="noopener" style={{ color: "rgba(255,255,255,0.7)", textDecoration: "none", fontSize: "14px", display: "flex", alignItems: "center", gap: "8px" }}>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="#db4c23"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"></path></svg>
                    Facebook
                  </a>
                </li>
                <li style={{ marginBottom: "12px" }}>
                  <a href="https://www.instagram.com/digitalvikingz" target="_blank" rel="noopener" style={{ color: "rgba(255,255,255,0.7)", textDecoration: "none", fontSize: "14px", display: "flex", alignItems: "center", gap: "8px" }}>
                ...
                <li style={{ marginBottom: "12px" }}>
                  <a href="https://www.youtube.com/@DigitalVikingz" target="_blank" rel="noopener" style={{ color: "rgba(255,255,255,0.7)", textDecoration: "none", fontSize: "14px", display: "flex", alignItems: "center", gap: "8px" }}>
                ...
                <li style={{ marginBottom: "12px" }}>
                  <a href="mailto:workwithus@digitalvikingz.com" style={{ color: "rgba(255,255,255,0.7)", textDecoration: "none", fontSize: "14px", display: "flex", alignItems: "center", gap: "8px" }}>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="#db4c23"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"></path></svg>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "16px" }}>
            <div style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: "11px", color: "rgba(255,255,255,0.4)", letterSpacing: "0.1em" }}>
              © 2026 Digital Vikingz · All rights reserved
            </div>
            <div style={{ fontFamily: "'Fraunces',Georgia,serif", fontStyle: "italic", fontSize: "14px", color: "rgba(255,255,255,0.6)" }}>
