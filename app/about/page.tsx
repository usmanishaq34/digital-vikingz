...
(function () {
  ...
  window.addEventListener('scroll', () => {
    ...
    if (window.scrollY > 80) {
      ...
      nav.style.boxShadow = '0 1px 0 rgba(10,10,10,0.06)';
    } else {
  ...
  document.querySelectorAll('[data-toggle]').forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      if (!target) return;
      const current = target.getAttribute('data-state') || 'in-practice';
      const next = current === 'in-practice' ? 'track-record' : 'in-practice';
...
`}</style>
      ...
      <header className="hero">
        ...
        <div className="wrap">
          ...
          <span className="hero-pill">
            Founder-led · Methodology-trained · Practitioner agency
          </span>
          <h1 className="h-display hero-h1">
            Architected by a practitioner,
            {' '}
            <em>
              not an agency.
            </em>
          ...
          <p className="hero-sub">
            Digital Vikingz is a
            {' '}
            <strong>
              semantic SEO authority agency
            </strong>
            {' '}
            founded by Usman Ishaq — a methodology-trained practitioner with 200+ shipped projects across 80+ industries. The agency runs lean by design. The work is methodology-grade because the practitioner running it owns the methodology — not because a sales deck says so.
          </p>
        ...
        <div className="wrap">
          <div className="section-head">
            ...
            <p className="section-intro">
              Most agencies sell methodology they don't actually own. The methodology Digital Vikingz applies is one I've spent years studying, applying, and refining across hundreds of projects. The bio below is the version that matters — not the LinkedIn version.
            </p>
          </div>
          <div className="founder-card">
            <div className="founder-portrait-wrap">
              ...
              <div className="founder-meta">
                <div className="founder-meta-row">
                  <span className="founder-meta-key">
                    Role
                  </span>
                  <span className="founder-meta-val">
                    Founder · CEO
                  </span>
                </div>
                <div className="founder-meta-row">
                ...
                <div className="founder-meta-row">
                  ...
                  <span className="founder-meta-val accent">
                    Koray-aligned
                  </span>
                </div>
                <div className="founder-meta-row">
            ...
            <div className="founder-bio">
              <span className="founder-bio-tag">
                Founder Bio
              </span>
              <h3>
                Usman
              ...
              <div className="founder-bio-role">
                Founder &amp; CEO · Digital Vikingz · Practitioner of semantic SEO
              </div>
              <p>
                I trained as a
                {' '}
                <strong>
                  mechanical engineer
                </strong>. After graduation, I pivoted into digital marketing — first as a freelance SEO content writer and WordPress developer, then deeper into semantic SEO as the discipline matured. The engineering background never left. It informs how I think about authority architecture:
                {' '}
                <strong>
                  entities as components, predicates as interfaces, governance as system design.
                </strong>
                {' '}
                Most career marketers think in narratives. Engineers think in dependencies. Semantic SEO is closer to systems engineering than to copywriting.
              </p>
              <p>
                I've been actively practicing on Upwork since 2023. Across that span, I've shipped
                {' '}
                <strong>
                  200+ projects across 80+ industries
                </strong>
                {' '}
                — from SaaS and finance to home services, legal, automotive, e-commerce, and education. The variety isn't a brag — it's how I learned which methodology principles transfer across verticals and which need vertical-specific adaptation.
                {' '}
                <strong>
                  You don't see what works until you've stress-tested the methodology against radically different category constraints.
                </strong>
              </p>
              <div className="founder-bio-pullquote">
                ...
                <span className="founder-bio-pullquote-attr">
                  Usman Ishaq
                  <span>
                    ·
                  </span>
                  on the agency model behind Digital Vikingz
                </span>
              </div>
              <h4 className="founder-bio-section-h">
                Why
                {' '}
                <em>
                  semantic SEO
              ...
              <p>
                Around 2021, I started working through Koray Tuğberk Gübür's body of work on semantic SEO — entity-first thinking, topical authority architecture, Source Term Vector consistency, predicate-clean infrastructure. The framework matched the way I'd been instinctively trying to build content systems but couldn't articulate.
                {' '}
                <strong>
                  It's the only SEO methodology I've encountered that holds up at the entity layer
                </strong>
                {' '}
                rather than the keyword layer — which means it's also the only methodology that compounds defensibly under AI retrieval and Google's ongoing entity-graph maturation.
              </p>
              <p>
                Since then, semantic SEO has become the operational core of every engagement Digital Vikingz runs. Not as a positioning angle. As
                {' '}
                <strong>
                  the actual operating system
                </strong>
                {' '}
                behind how we architect topical authority, govern editorial production, deploy structured data, and measure outcomes.
              </p>
              <h4 className="founder-bio-section-h">
                Why
                {' '}
              ...
              <p>
                Digital Vikingz exists because most SEO agencies sell tactics — keyword research, link building, technical audits — without an architectural framework underneath. The work compounds for 6–12 months, then breaks under the next algorithm update.
                {' '}
                <strong>
                  Authority that survives requires structural foundations
                </strong>, not tactical execution. The agencies I'd want to hire didn't exist at a price point most businesses could afford. So I built one.
              </p>
              <p>
                The agency runs
                {' '}
                <strong>
                  lean by design
                </strong>. Methodology-trained team, not high headcount. Founder-led on every architecture engagement — not handed off to an account manager. I read every deliverable that ships under the Digital Vikingz name.
                {' '}
                <strong>
                  That doesn't scale to a 50-person agency. It does scale to producing methodology-grade work.
                </strong>
              </p>
            </div>
          </div>
      ...
      <section className="practitioner-section">
        <div className="wrap">
          <div className="practitioner-head">
            ...
            <p className="section-intro">
              Below: the practitioner record compressed into one console with two states.
              {' '}
              <strong>
                In Practice
              </strong>
              {' '}
              shows what's currently active — engagements running, methodology applications live, regions being served right now.
              {' '}
              <strong>
                Track Record
              </strong>
              {' '}
              shows the cumulative footprint — projects shipped, verticals served, methodology lineage timeline. Toggle to see both.
            </p>
          </div>
          <div className="practitioner-console" id="practitionerConsole" data-state="in-practice">
            <div className="pc-header">
              <div className="pc-header-left">
                <span className="pc-pill">
                  <span className="pc-state-block pc-state-practice">
                    Live · In Practice
                  </span>
                  <span className="pc-state-block pc-state-record">
                    Live · Track Record
                  </span>
                </span>
                <span className="pc-title">
                  <span className="pc-state-block pc-state-practice">
                    ...
                    {' '}
                    <strong>
                      active engagements &amp; current applications
                    </strong>
                  </span>
                  <span className="pc-state-block pc-state-record">
                    Practitioner state ·
                    {' '}
                    <strong>
                      cumulative record &amp; methodology lineage
                    </strong>
                  </span>
                </span>
              </div>
              <button type="button" className="pc-toggle-btn" data-toggle="practitionerConsole" aria-label="Toggle between in-practice and track-record">
            ...
            <div className="pc-stat-row">
              <div className="pc-stat-cell">
                ...
                <span className="pc-stat-detail">
                  <span className="pc-state-block pc-state-practice">
                    Across 6 verticals · 4 regions
                  </span>
                  <span className="pc-state-block pc-state-record">
                    Cumulative · 2023 to present
                  </span>
                </span>
              </div>
              <div className="pc-stat-cell">
                ...
                <span className="pc-stat-detail">
                  ...
                  <span className="pc-state-block pc-state-record">
                    SaaS · finance · home · legal · auto · ecom · ed · health
                  </span>
                </span>
              </div>
              <div className="pc-stat-cell">
                ...
                <span className="pc-stat-detail">
                  <span className="pc-state-block pc-state-practice">
                    Active monthly · methodology-governed
                  </span>
                  <span className="pc-state-block pc-state-record">
                    Continuous semantic SEO practice
                  </span>
                </span>
              </div>
              <div className="pc-stat-cell">
                ...
                <span className="pc-stat-detail">
                  <span className="pc-state-block pc-state-practice">
                    US · UK · CA · AU active this cycle
                  </span>
                  <span className="pc-state-block pc-state-record">
                    N. America · Europe · Asia · Australia · MENA
                  </span>
                </span>
              </div>
            </div>
            ...
            <div className="pc-body">
              {/* IN PRACTICE STATE */}
              <div className="pc-state-block pc-state-practice">
                <div className="pc-body-section">
                  <div className="pc-body-h">
                    ▸ Engagements active this cycle
                  </div>
                  <div className="pc-body-rows">
                    <div className="pc-row">
                      <div className="pc-row-key">
                        SaaS · USA
                      </div>
                      <div className="pc-row-detail">
                        ...
                        {' '}
                        <strong>
                          architecture in flight · Week 06 of 10
                        </strong>
                      </div>
                      <div className="pc-row-status">
                        <span className="pc-row-status-dot"></span>
                        ▸ Building
                      </div>
                    </div>
                    <div className="pc-row">
                    ...
                    <div className="pc-row">
                      ...
                      <div className="pc-row-detail">
                        ...
                        {' '}
                        <strong>
                          GBP content cycle · production active
                        </strong>
                      </div>
                      <div className="pc-row-status">
                        <span className="pc-row-status-dot"></span>
                    ...
                    <div className="pc-row">
                      ...
                      <div className="pc-row-detail">
                        Consulting prep platform ·
                        {' '}
                        <strong>
                          cluster production · cycle 03
                        </strong>
                      </div>
                      <div className="pc-row-status">
                        <span className="pc-row-status-dot"></span>
                    ...
                    <div className="pc-row">
                      ...
                      <div className="pc-row-detail">
                        ...
                        {' '}
                        <strong>
                          entity architecture proposal under review
                        </strong>
                      </div>
                      <div className="pc-row-status">
                        <span className="pc-row-status-dot"></span>
                ...
                <div className="pc-body-section">
                  ...
                  <div className="pc-body-rows">
                    <div className="pc-row">
                      ...
                      <div className="pc-row-detail">
                        12 active definitions ·
                        {' '}
                        <strong>
                          4 newly cascaded this month
                        </strong>
                      </div>
                      <div className="pc-row-status">
                        <span className="pc-row-status-dot"></span>
                    ...
                    <div className="pc-row">
                      ...
                      <div className="pc-row-detail">
                        8 specifications enforced ·
                        {' '}
                        <strong>
                          0 banned-phrase violations this cycle
                        </strong>
                      </div>
                      <div className="pc-row-status">
                        <span className="pc-row-status-dot"></span>
                    ...
                    <div className="pc-row">
                      ...
                      <div className="pc-row-detail">
                        ...
                        {' '}
                        <strong>
                          monthly retrieval testing across 4 LLMs
                        </strong>
                      </div>
                      <div className="pc-row-status">
                        <span className="pc-row-status-dot"></span>
              ...
              {/* TRACK RECORD STATE */}
              <div className="pc-state-block pc-state-record">
                <div className="pc-body-section">
                  <div className="pc-body-h">
                    ▸ Vertical coverage · cumulative
                  </div>
                  <div className="pc-body-rows">
                    <div className="pc-row">
                      <div className="pc-row-key">
                      ...
                      <div className="pc-row-detail">
                        ...
                        {' '}
                        <strong>
                          workflow automation · DevTools · vertical SaaS
                        </strong>
                      </div>
                      <div className="pc-row-status">
                        <span className="pc-row-status-dot"></span>
                    ...
                    <div className="pc-row">
                      ...
                      <div className="pc-row-detail">
                        ...
                        {' '}
                        <strong>
                          home · legal · medical · automotive · trades
                        </strong>
                      </div>
                      <div className="pc-row-status">
                        <span className="pc-row-status-dot"></span>
                    ...
                    <div className="pc-row">
                      ...
                      <div className="pc-row-detail">
                        ...
                        {' '}
                        <strong>
                          fashion · auto · pet · home · health products
                        </strong>
                      </div>
                      <div className="pc-row-status">
                        <span className="pc-row-status-dot"></span>
                    ...
                    <div className="pc-row">
                      ...
                      <div className="pc-row-detail">
                        ...
                        {' '}
                        <strong>
                          YMYL-grade SME review · regulatory layer
                        </strong>
                      </div>
                      <div className="pc-row-status">
                        <span className="pc-row-status-dot"></span>
                    ...
                    <div className="pc-row">
                      ...
                      <div className="pc-row-detail">
                        ...
                        {' '}
                        <strong>
                          consulting prep · learning platforms · creator ed
                        </strong>
                      </div>
                      <div className="pc-row-status">
                        <span className="pc-row-status-dot"></span>
                    ...
                    <div className="pc-row">
                      ...
                      <div className="pc-row-detail">
                        ...
                        {' '}
                        <strong>
                          SaaS-adjacent · creative · misc verticals
                        </strong>
                      </div>
                      <div className="pc-row-status">
                        <span className="pc-row-status-dot"></span>
                ...
                <div className="pc-body-section">
                  ...
                  <div className="pc-body-rows">
                    <div className="pc-row">
                      ...
                      <div className="pc-row-detail">
                        Active practice begins ·
                        {' '}
                        <strong>
                          SEO content + WordPress development on Upwork
                        </strong>
                      </div>
                      <div className="pc-row-status">
                        <span className="pc-row-status-dot"></span>
                    ...
                    <div className="pc-row">
                      ...
                      <div className="pc-row-detail">
                        Encountered Koray Tuğberk Gübür's work ·
                        {' '}
                        <strong>
                          methodology adoption begins
                        </strong>
                      </div>
                      <div className="pc-row-status">
                        <span className="pc-row-status-dot"></span>
                    ...
                    <div className="pc-row">
                      ...
                      <div className="pc-row-detail">
                        Semantic SEO becomes operational core ·
                        {' '}
                        <strong>
                          first cross-vertical applications
                        </strong>
                      </div>
                      <div className="pc-row-status">
                        <span className="pc-row-status-dot"></span>
                    ...
                    <div className="pc-row">
                      ...
                      <div className="pc-row-detail">
                        Digital Vikingz formalized ·
                        {' '}
                        <strong>
                          agency structure · methodology-trained team
                        </strong>
                      </div>
                      <div className="pc-row-status">
                        <span className="pc-row-status-dot"></span>
                    ...
                    <div className="pc-row">
                      ...
                      <div className="pc-row-detail">
                        AI/LLM visibility layer added ·
                        {' '}
                        <strong>
                          methodology extended to retrieval engineering
                        </strong>
                      </div>
                      <div className="pc-row-status">
                        <span className="pc-row-status-dot"></span>
                    ...
                    <div className="pc-row">
                      ...
                      <div className="pc-row-detail">
                        200+ projects · 40+ verticals ·
                        {' '}
                        <strong>
                          5 continents · methodology compounding
                        </strong>
                      </div>
                      <div className="pc-row-status">
                        <span className="pc-row-status-dot"></span>
            ...
            <div className="pc-foot">
              <span className="pc-foot-text">
                ...
                <span className="pc-state-block pc-state-record">
                  ...
                  · methodology lineage compounding
                </span>
              </span>
            </div>
          </div>
      ...
      <section className="section lineage" id="lineage">
        <div className="wrap">
          <div className="section-head">
            ...
            <p className="section-intro">
              The methodology Digital Vikingz applies isn't original. It's adapted from Koray Tuğberk Gübür's body of work on semantic SEO. Pretending otherwise would be the kind of dishonesty that breaks the entire trust structure of this page.
              {' '}
              <strong>
                Honest attribution + named adaptations
              </strong>
              {' '}
              is the right posture — and it's the same posture every other page on this site takes.
            </p>
          </div>
          <div className="lineage-grid">
            <div className="lineage-block attribution">
              <span className="lineage-tag">
                Attribution
              </span>
              <h3>
                Built on
              ...
              <p>
                The semantic SEO methodology applied across every Digital Vikingz engagement is rooted in
                {' '}
                <strong>
                  Koray Tuğberk Gübür's published body of work
                </strong>
                {' '}
                — entity-first authority architecture, topical map design, Source Term Vector consistency, predicate cleanliness, agreement-area analysis, query path mapping, and Information Gain engineering.
              </p>
              <p>
                Koray is the
                {' '}
                <strong>
                  methodologist of record
                </strong>. Digital Vikingz is a practitioner agency that applies that methodology across client engagements. We don't claim Koray endorses us. We don't claim methodology origination. We claim what's true:
                {' '}
                <strong>
                  experienced practitioners of his framework
                </strong>, with 200+ projects of applied execution.
              </p>
              <ul className="lineage-list">
                <li>
                  <span className="lineage-list-num">
                    Concept 01
                  </span>
                  <span className="lineage-list-title">
                    Topical
                    {' '}
                    <em>
                      Authority
                  ...
                  <span className="lineage-list-detail">
                    Authority compounds when entities, predicates, and topical maps are governed coherently — not when keywords stack up.
                  </span>
                </li>
                <li>
                  <span className="lineage-list-num">
                  ...
                  <span className="lineage-list-detail">
                    A site's authority binds to a single locked Central Entity definition. Drift here breaks every layer above it.
                  </span>
                </li>
                <li>
                  <span className="lineage-list-num">
                  ...
                  <span className="lineage-list-detail">
                    A site's vocabulary is its semantic signature. Inconsistent terminology fragments authority at the entity layer.
                  </span>
                </li>
                <li>
                  <span className="lineage-list-num">
                  ...
                  <span className="lineage-list-detail">
                    Pages contributing net-new attributes beyond the SERP agreement area get retrieved disproportionately by AI systems.
                  </span>
                </li>
              </ul>
            </div>
            <div className="lineage-block adaptation">
              ...
              <h3>
                ...
                {' '}
                <em>
                  we apply differently
                </em>
              </h3>
              <p>
                Within Koray's framework, three operational adaptations have emerged from running 200+ engagements across 40+ verticals.
                {' '}
                <strong>
                  None of these contradict the underlying methodology.
                </strong>
                {' '}
                They extend it into operational territory the published work touches lightly — because applying methodology at agency scale surfaces problems theoretical work doesn't always address.
              </p>
              <p>
                These adaptations are
                {' '}
                <strong>
                  practitioner-level decisions
                </strong>, not methodological revisions. Koray's framework is the source. Our adaptations are how we operationalize it under the constraints of paid client engagements at variable budgets.
              </p>
              <ul className="lineage-list">
                <li>
                  <span className="lineage-list-num">
                  ...
                  <span className="lineage-list-detail">
                    My mechanical engineering background informs how we model entities (components), predicates (interfaces), and governance (system design). The architecture deliverables look more like engineering specs than content briefs.
                  </span>
                </li>
                <li>
                  <span className="lineage-list-num">
                  ...
                  <span className="lineage-list-detail">
                    200+ projects across 40+ verticals produced documented vertical playbooks — local services run differently from SaaS, which run differently from YMYL finance. The methodology is universal; the configuration is vertical-specific.
                  </span>
                </li>
                <li>
                  <span className="lineage-list-num">
                  ...
                  <span className="lineage-list-detail">
                    We extended the framework into post-search retrieval — engineering for ChatGPT, Perplexity, Claude, Gemini, and AI Overviews citations. The structural moves that make sites rank also make them retrievable; the AI layer adds Information Gain testing across LLM surfaces.
                  </span>
                </li>
              </ul>
            </div>
      ...
      <section className="section team" id="team">
        <div className="wrap">
          <div className="section-head">
            ...
            <p className="section-intro">
              Digital Vikingz is a small team. That's a deliberate choice, not a stage we're trying to grow out of. Every team member is methodology-trained on the governance manual before producing client work.
              {' '}
              <strong>
                No outsourced contractor pools.
              </strong>
              {' '}
              No fake team-size inflation. No stock photos with made-up names. Below: who actually does the work.
            </p>
          </div>
          <div className="team-grid">
            <div className="team-card">
              ...
              <p className="team-bio">
                Owns architecture engagements end-to-end. Reads every deliverable that ships under the Digital Vikingz name. Engineering background informs how authority architectures get built.
                {' '}
                <strong>
                  Founder-led on every Claim-tier engagement
                </strong>
                {' '}
                — not handed off to account managers.
              </p>
            </div>
            <div className="team-card">
              <div className="team-portrait">
              ...
              <p className="team-bio">
                Operations backbone of the agency. Manages production workflows, cycle scheduling, and team capacity alignment across active engagements.
                {' '}
                <strong>
                  If a deliverable ships on time, it's because Umair tracked it
                </strong>.
              </p>
            </div>
            <div className="team-card">
              ...
              <p className="team-bio">
                Editorial leadership across content production engagements. Multi-pass QA on every asset — predicate consistency, banned-phrase scans, schema validation, internal linking compliance.
                {' '}
                <strong>
                  The reason zero banned-phrase violations ship
                </strong>.
              </p>
            </div>
          </div>
          <div className="team-extra">
            <div className="team-extra-icon">
              W
            </div>
            <div className="team-extra-text">
              Plus a
              {' '}
              <strong>
                methodology-trained writer network
              </strong>
              {' '}
              for production scaling. Each writer is onboarded on the client's governance manual, Source Term Vector specification, and predicate framework
              {' '}
              <em>
                before
              </em>
              ...
              {' '}
              <strong>
                Writers don't guess — they execute against governance specs.
              </strong>
            </div>
          </div>
        </div>
      ...
      <section className="section geo" id="geo">
        <div className="wrap">
          <div className="section-head">
            ...
            <p className="section-intro">
              Digital Vikingz operates remote-first from Bahawalpur, Pakistan. Most engagements run async — written deliverables, scheduled review calls, Slack/email channels.
              {' '}
              <strong>
                Geography hasn't been a constraint
              </strong>
              {' '}
              across 200+ projects. The methodology is what scales globally; the timezone is just a logistics detail.
            </p>
          </div>
          <div className="geo-grid">
            <div className="geo-base">
              <span className="geo-base-tag">
                Home Base
              </span>
              <h3 className="geo-base-h">
                Bahawalpur,
                {' '}
                <em>
                  Pakistan
              ...
              <p className="geo-base-p">
                A mid-sized city in southern Punjab — not Karachi, not Islamabad. The base is deliberate. Lower overhead than Tier-1 SEO agency cities means we can run methodology-grade engagements at price points that would be unviable from London or NYC.
                {' '}
                <strong>
                  The methodology is the value
                </strong>; the geography reduces the cost of delivering it.
              </p>
              <p className="geo-base-p">
                Most client communication runs
                {' '}
                <strong>
                  async
                </strong>
                {' '}
                — written deliverables, recorded walkthroughs, scheduled review calls. Live calls scheduled within a 12-hour window aligned to the client's region.
              </p>
              <div className="geo-base-meta">
                <div className="geo-base-meta-row">
                  <span className="geo-base-meta-key">
                    Timezone
                  </span>
                  <span className="geo-base-meta-val">
                    PKT · UTC +05:00
                  </span>
                </div>
                <div className="geo-base-meta-row">
            ...
            <div className="geo-regions">
              <span className="geo-regions-h">
                ▸ Active Client Regions
              </span>
              <div className="geo-region">
                <span className="geo-region-flag">
                  US
                </span>
                <span className="geo-region-name">
                  United States
                </span>
                <span className="geo-region-detail">
                  Largest base
                </span>
              </div>
              <div className="geo-region">
      ...
      <section className="section donts" id="donts">
        <div className="wrap">
          <div className="section-head">
            ...
            <p className="section-intro">
              Disqualification is a credibility move. Most agencies will say yes to anything that sends a wire transfer. Below is the explicit list of work Digital Vikingz declines — even when offered. This list isn't exhaustive, but it covers the patterns that come up repeatedly in scoping calls.
            </p>
          </div>
          <div className="donts-grid">
            <div className="dont-card">
              <span className="dont-card-num">
                Decline 01
              </span>
              <h4>
                PBN, link networks,
              ...
              <p>
                We don't build private blog networks. We don't run guest post networks with low editorial standards. We don't pay for placements.
                {' '}
                <strong>
                  Every link in our authority engagements is editorially earned
                </strong>
                {' '}
                on category-aligned publications. If a category genuinely has no editorially-earnable placements, we tell you that and decline the link engagement.
              </p>
            </div>
            <div className="dont-card">
              <span className="dont-card-num">
              ...
              <p>
                We don't lead engagements with keyword research. The methodology is entity-first — Central Entity, topical map, predicate framework, then queries derive from that structure.
                {' '}
                <strong>
                  Keyword-first SEO produces fragile authority that breaks under algorithm updates.
                </strong>
                {' '}
                If keyword research is your starting point, we're wrong fit.
              </p>
            </div>
            <div className="dont-card">
              <span className="dont-card-num">
              ...
              <p>
                Authority compounds over quarters, not weeks. We don't make 30-day or 60-day ranking promises because the underlying mechanics don't work that way.
                {' '}
                <strong>
                  Agencies that make those promises are either lying or building short-term tactics
                </strong>
                {' '}
                that break the moment the next update lands. We won't compete with them on timeline; we compete on durability.
              </p>
            </div>
            <div className="dont-card">
              <span className="dont-card-num">
              ...
              <h4>
                ...
                {' '}
                <em>
                  or extractive verticals
                </em>
              </h4>
              <p>
                We decline engagements in adult content, online gambling outside regulated markets, predatory financial products, and other extractive verticals.
                {' '}
                <strong>
                  The methodology can't undo the harm
                </strong>, and authority engineering for those verticals would be aiding it. Not a moral lecture — just an explicit scope boundary.
              </p>
            </div>
            <div className="dont-card">
              <span className="dont-card-num">
              ...
              <p>
                For Content Network engagements (Service 05), we don't ghostwrite under fictional expert personas. The expert voice has to be a real person with category credibility on record.
                {' '}
                <strong>
                  Fake expert personas are detectable and reputationally fragile.
                </strong>
                {' '}
                If you don't have an expert voice available, the service isn't right for you.
              </p>
            </div>
            <div className="dont-card">
              <span className="dont-card-num">
              ...
              <p>
                If a prospect explicitly wants tactics-first SEO, generic content writing, or quick-win optimization, we decline.
                {' '}
                <strong>
                  Forcing methodology onto unwilling clients produces frustration on both sides.
                </strong>
                {' '}
                Better to point them toward a generalist agency that fits their model than to take work that compounds nothing.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="final-cta" id="cta">
        <div className="wrap">
          ...
          <p>
            Most agencies sell methodology they don't actually own. The strategy call goes directly to the founder — not an SDR, not an account manager. If we're right fit, you'll know in 30 minutes. If we're not, I'll tell you who is.
          </p>
