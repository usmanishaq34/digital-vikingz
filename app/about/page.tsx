                  ...
                  <div className="mega-grid-inner" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", padding: "24px 28px 26px", gap: "0 40px" }}>
                    <div>
                      ...
                      <ul style={{ listStyle: "none", margin: "0 0 20px 0", padding: "0" }}>
                        ...
                        <li><a data-svc="semantic-content-audit" className="svc-link" href="/services/semantic-content-audit" style={{ textDecoration: "none", display: "block", padding: "8px 0" }}><div style={{ fontFamily: "'Inter',sans-serif", fontSize: "16px", fontWeight: "500", color: "#111", lineHeight: "1.3", marginBottom: "2px" }}>Semantic Content Audit</div><div style={{ fontFamily: "monospace", fontSize: "11px", color: "#888", lineHeight: "1.3" }}>Diagnostic foundation · Custom scoped</div></a></li>
                      </ul>
        ...
        <div className="wrap">
          ...
          <div className="founder-card">
            ...
            <div className="founder-bio">
              ...
              <p>I've been actively practicing on Upwork since 2023. Across that span, I've shipped <strong>200+ projects across 40+ industries</strong> — from SaaS and finance to home services, legal, automotive, e-commerce, and education. The variety isn't a brag — it's how I learned which methodology principles transfer across verticals and which need vertical-specific adaptation. <strong>You don't see what works until you've stress-tested the methodology against radically different category constraints.</strong></p>
